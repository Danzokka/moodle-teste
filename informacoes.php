...
<head>
    ...
    <title>Inscrição do curso</title>
...
CURLOPT_URL => $urlCursoIndividual.$_GET['id'],
                ...
                <div class="area_inscricao_int_curso">
                    <div class="numeracao_info_inscricao">
                        ...
                        <div class="area_numeracao_inscricao_2">
                            <div class="numeracao_info_2">
                                <div class="numero_title_inscricao_2">
                                    <h2>
                                        2
                                    </h2>
                                </div>
                    ...
                    <div class="line_inscricao"></div>
                    <div class="line_inscricao_2"></div>

                </div>

                <div class="area_nome_curso">
                    <img class="curso_novo_img" src="img/curso_novo_negocio.png" alt="">

                    <div class="area_texts_curso">
                        <div class="title_curso_novo">
                            <h2>
                                <?php  echo $retorno->shorname; ?>
                            </h2>
                        </div>

                        <div class="area_info_curso_novo">
                            <div class="title_info_curso_novo">
                                <h2>
                                    Descrição
                                </h2>
                            </div>
                            <div class="sub_title_info_curso_novo">
                                <p>
                                    <?php echo $retorno->descricaocurta; ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="area_info_curso_novo">
                            ...
                            <div class="sub_title_info_curso_novo">
                                <p>
                                <?php
                                $publicos = $ret->publico;
                                // Objeto "publico"
                                foreach ($publicos as $key => $value) {
                                    // Exibe a chave e o valor
                                    if($key!="_id" and $key!="courseid" and $value!="0"){
                                        $arraypublicos .= $value.', ';
                                    }
                                }
                                echo substr($arraypublicos,0,-2);
                                ?>
                                </p>
                            </div>
                        </div>

                        <div class="line_curso_novo"></div>


                        <div class="area_inscricao_curso_novo">

                            <div class="area_info_inscricao">

                                <img src="img/vagas.svg" alt="">

                                <div class="area_info_texts_inscricao">
                                    <div class="title_texts_incricao">
                                        <h2>
                                            Vagas:
                                        </h2>
                                    </div>
                                    <div class="sub_title_texts_incricao">
                                        <p>
                                        <?php 
										if($retorno->qtdvagas=="0"){
											echo 'Ilimitadas';
										}else{
											echo $retorno->qtdvagas;
										}?>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="area_info_inscricao">
                                ...
                                <div class="area_info_texts_inscricao">
                                    ...
                                    <div class="sub_title_texts_incricao">
                                        <p>
                                            <?php
											$dti_inicioAno = date('Y', substr($retorno->dti_inicio,0,11));
											$dti_inicioMes = date('m', substr($retorno->dti_inicio,0,11));
											$dti_inicioDia = date('d', substr($retorno->dti_inicio,0,11));
											echo $dti_inicioDia.'/'.$dti_inicioMes.'/'.$dti_inicioAno;
											?>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="area_info_inscricao">
                                ...
                                <div class="area_info_texts_inscricao">
                                    ...
                                    <div class="sub_title_texts_incricao">
                                        <p>
                                            <?php
											$enddateAno  = date('Y', substr($retorno->enddate,0,11));
											$enddateMes  = date('m', substr($retorno->enddate,0,11));
											$enddateDia  = date('d', substr($retorno->enddate,0,11));
											if($retorno->enddate=="0"){
												echo 'Sem data final';
											}else{
												echo $enddateDia.'/'.$enddateMes.'/'.$enddateAno;
											}
											?>
                                        </p>
                                    </div>
                            ...
                            <div class="area_btns_curso_novo">

                                <div class="btn_voltar" onclick="location.href='curso.php?id=<?=$_GET['id'];?>'">
                                ...
                                <div class="btn_inscreva_se" onclick="location.href='cadastro.php?id=<?=$_GET['id'];?>'">
