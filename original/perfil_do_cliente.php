            ...
            <div class="area_container_1">
                <div class="card_perfil">
                    <div class="card_perfil_int">
                        <img src="img_perfil/perfil.png" alt="">
                        ...
                        <div class="info_perfil">
                            ...
                            <p>
                                E-mail: romuloafonson@gmail.com
                            </p>
                            <p>
                                Data de nascimento: 03/01/1978
                            </p>
                            <p>
                                WhatsApp: 61 98190-3433
                            </p>
                        </div>
                        ...
                        <div class="area_ranking_total">
                            <div class="area_ranking">
                                <div class="area_ranking_int">
                                    <img src="img_perfil/perfil_ranking.png" alt="">
                    ...
                    <div class="card_tempo_int">
                        <div class="area_tempo">
                            ...
                            <div class="info_tempo">
                                <p>
                                    Inscrito desde: 23/01/2019
                                </p>

                                <p>
                                    Tempo de uso: 126 horas
                                </p>
                                <p>
                                    Certificados emitidos: 09
                                </p>
                                <p>
                                    Cursos em andamento: 03
                                </p>
                            </div>
    ...
    <div class="container_2">
        <div class="container_2_int">
            ...
            <div class="area_btns_cursos">
                <div class="btn_cursos_opcao select">
                    <div class="title_btn_cursos_opcao select">
                        <h2>
                            Cursos em andamento
                        </h2>
                    </div>
                </div>
                <div class="btn_cursos_opcao">
            ...
            <div class="area_container_2_total">
                <div class="area_pesquisa">
                    ...
                    <div class="title_cursos_pesquisa">
                        <h2>
                            Curso em andamento
                        </h2>
                    </div>
                    ...
                    <div class="card_cursos_online">
                        <div class="card_cursos_online_int">
                            <div class="area_img_cursos_online">
                                ...
                                <img src="img_perfil/card_cursos.png" alt="">
                            </div>

                            <div class="area_texts_cursos_online_total">
                    ...
                    <table class="bordered striped centered highlight responsive-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <!--<td>
                                    <div class="area_certificado">
                                        <a href="#">
                                            <div class="btn_certificado animation_btns">
